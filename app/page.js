...
export default function Home() {
  ...
  return (
    ...
    <h1 className="text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-red-600 shadow-lg hover:scale-105 transition-transform duration-300 ease-in-out">
      Professional Profile
    </h1>
    <span className="text-7xl font-bold text-white ml-3 align-top">.</span>
</div>
